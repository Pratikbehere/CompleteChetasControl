...
import wateraudit from "../../assets/Images/Services/WaterAudits/wateraudit.png";

const images = [wateraudit];
const auditNames = ["Water Audit"];
  ...
  const highlights = [
    {
      ...
      desc: "Detailed evaluation of water inflow, outflow, and losses across the system.",
    },
    {
      icon: <LineChart className="w-8 h-8 text-white" />,
      title: "Smart Data Integration",
      desc: "Combines SCADA and smart metering data for efficient water analysis.",
    },
    {
      icon: <Droplets className="w-8 h-8 text-white" />,
      title: "Leakage Detection",
      desc: "Identifies leakages, inefficiencies, and non-revenue water sources.",
    },
    {
      icon: <Settings className="w-8 h-8 text-white" />,
      title: "Optimization Solutions",
      desc: "Provides recommendations to optimize water usage and reduce waste.",
    },
    {
      icon: <AlertTriangle className="w-8 h-8 text-white" />,
      title: "Loss Reduction",
      desc: "Helps reduce operational costs by minimizing wastage and inefficiency.",
    },
    {
      icon: <ClipboardCheck className="w-8 h-8 text-white" />,
      title: "Regulatory Compliance",
      desc: "Ensures compliance with government water audit standards and norms.",
    },
  ];
    ...
    <div className="w-full min-h-screen bg-white text-gray-800 font-['Poppins'] overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-600 mt-3 text-base md:text-lg max-w-2xl mx-auto">
          Professional water audit services for efficient, sustainable, and transparent water management.
        </p>
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
      ...
      >
        ...
        <div className="space-y-5 text-gray-700 text-[1rem]">
          <p>
            Water is one of the most critical natural resources, and its efficient management is essential for sustainability.
            Our Water Audit services analyze complete water supply and distribution systems to ensure optimal usage and minimal wastage.
          </p>
          <p>
            We conduct audits for dams, reservoirs, industries, and water systems — examining every stage of water flow, from source to distribution.
            Using advanced monitoring tools, flow meters, and SCADA data, we detect leakages and inefficiencies and recommend corrective measures.
          </p>
          <p>
            Our reports identify non-revenue water (NRW), losses, and improvement areas, offering actionable solutions for energy conservation and cost reduction.
            We also help clients comply with national water management standards.
          </p>
        </div>
      </motion.div>
